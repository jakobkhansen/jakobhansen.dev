...
In my opinion, Lua has made both writing plugins and using plugins more flexible, its easy
...
Finally, Tree-sitter is a language-agnostic incremental-parser generator. In layman's terms its a
...
*Visualization of part of the AST tree-sitter generates*

[Tree-sitter for Neovim](https://github.com/nvim-treesitter/nvim-treesitter) is used for
syntax highlighting, but is very extensible for users and plugin authors
